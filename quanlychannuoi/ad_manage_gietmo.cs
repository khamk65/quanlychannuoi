...
{
    public partial class ad_manage_gietmo : Form
    {
        private Database database;

        public ad_manage_gietmo()
        {
            InitializeComponent();
        ...
        private void ShowCosogietmoData()
        {
            try
            {
                ...
                DataTable cosogietmoData = database.GetData("cosogietmo");
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            if (GridViewAccounts.SelectedRows.Count > 0)
            {
                ...
                bool deleteSuccess = database.DeleteData("cosogietmo", Convert.ToInt32(primaryKeyValue));
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            bool insertSuccess = database.InsertData("cosogietmo", new Dictionary<string, object>
        {
            { "ten", ten },
            { "nguoilienhe", nguoilienhe },
            { "email", email },
