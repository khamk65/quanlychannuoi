...
{
    public partial class ad_manage_khaonghiem : Form
    {
        private Database database;
        public ad_manage_khaonghiem()
        {
            InitializeComponent();
        ...
        private void ShowCosokhaonghiemData()
        {
            try
            {
                ...
                DataTable cososanxuatData = database.GetCosokhaonghiemData();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (GridViewAccounts.SelectedRows.Count > 0)
            {
                ...
                bool deleteSuccess = database.DeleteCosokhaonghiem(Convert.ToInt32(primaryKeyValue));
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            bool insertSuccess = database.InsertCosokhaonghiem(ten, nguoilienhe, email, phone, diachi);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (GridViewAccounts.SelectedRows.Count > 0)
            {
                ...
                bool updateSuccess = database.UpdateCosokhaonghiem(Convert.ToInt32(primaryKeyValue), ten, nguoilienhe, email, phone, diachi);
